...
class WorkflowRunDetailsResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'actions' => WorkflowActionRunResource::collection($this->whenLoaded('actionRuns')),
            'approvalRequests' => ApprovalRequestResource::collection($this->whenLoaded('approvalRequests')),
