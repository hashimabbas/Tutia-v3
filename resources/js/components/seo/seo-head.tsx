...
function serviceSchema() {
    return {
        ...
        description:
            'Enterprise-grade digital solutions including E-commerce, ERP, Connectivity, CRM, and custom software development for Sudanese businesses.',
        areaServed: {
            '@type': 'Country',
            name: 'SD',
        },
        hasOfferCatalog: {
            ...
            itemListElement: [
                ...
                {
                    '@type': 'Offer',
                    itemOffered: { '@type': 'Service', name: 'ERP Systems' },
                },
                {
                    '@type': 'Offer',
                    itemOffered: {
                ...
                {
                    '@type': 'Offer',
                    itemOffered: { '@type': 'Service', name: 'CRM Solutions' },
                },
                {
                    '@type': 'Offer',
                    itemOffered: {
