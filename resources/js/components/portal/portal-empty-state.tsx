...
export function PortalEmptyState({ icon: Icon = Inbox, title, description, action }: PortalEmptyStateProps) {
    return (
        <div className="flex flex-col items-center justify-center py-12">
            ...
            {description && <p className="mt-1 text-[11px] text-[#8b8b9e]">{description}</p>}
            {action && (
                <button
