...
const TEAM_VALUES = [
    {
        ...
        titleAr: 'التعاون',
        description:
            'We work together across teams and disciplines to deliver the best outcomes for our clients.',
        descriptionAr:
            'نعمل معاً عبر الفرق والتخصصات لتحقيق أفضل النتائج لعملائنا.',
    },
    {
        icon: Lightbulb,
        title: 'Innovation',
        titleAr: 'الابتكار',
        description:
            'We embrace creative thinking and continuous learning to stay ahead of the technology curve.',
        descriptionAr:
            'نتبنى التفكير الإبداعي والتعلم المستمر لنبقى في صدارة المنحنى التقني.',
    },
    {
        icon: Award,
        title: 'Excellence',
        titleAr: 'التميز',
        description:
            'We hold ourselves to the highest standards, delivering quality in everything we do.',
    ...
    },
    {
        ...
        titleAr: 'التنوع',
        description:
            'We celebrate diverse perspectives and backgrounds, knowing they make our team stronger.',
        descriptionAr:
            'نحتفي بوجهات النظر والخلفيات المتنوعة، مدركين أنها تجعل فريقنا أقوى.',
    },
];
...
export default function Team() {
    ...
    return (
        <>
            <Head
                title={locale === 'ar' ? 'فريقنا - توتيا' : 'Our Team - TUTIA'}
            >
                <meta
                    name="description"
                    content={
                        locale === 'ar'
                            ? 'تعرف على فريق توتيا وقيمنا'
                            : 'Meet the TUTIA team and our values'
                    }
                />
            </Head>
