...
export default function AboutIndex() {
    ...
    const quickLinks = [
        { href: '/about/leadership', label: t('about.leadership'), labelAr: 'الإدارة' },
        { href: '/about/team', label: t('about.team'), labelAr: 'فريقنا' },
        { href: '/about/values', label: t('about.values'), labelAr: 'قيمنا' },
        { href: '/about/culture', label: t('about.culture'), labelAr: 'ثقافتنا' },
    ];
                ...
                <Container>
                    <div className="grid gap-10 md:grid-cols-2">
                        <div className="rounded-xl border border-neutral-200 bg-white p-8">
                            ...
                            <Text variant="body" className="mt-4 text-neutral-600">
                                {locale === 'ar'
                            ...
                            return (
                                <div key={value.id} className="flex flex-col items-center text-center">
                                    <div className="mb-4 flex size-16 items-center justify-center rounded-full bg-brand-gold-500/10 p-3">
                                        <img
                                            src={valueImage}
                                            alt={locale === 'ar' ? value.titleAr : value.title}
