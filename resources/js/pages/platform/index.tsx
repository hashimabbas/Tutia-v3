...
import { Store, ShoppingBag, Check, Smartphone, ArrowRight } from 'lucide-react';
...
export default function PlatformIndex() {
    ...
    const sellerBenefits = locale === 'ar'
        ? ['أنشئ متجرك الإلكتروني مجاناً', 'وصل إلى آلاف المشترين', 'إدارة المخزون والطلبات بسهولة']
        : ['Create your online store for free', 'Reach thousands of buyers', 'Easily manage inventory and orders'];

    const buyerBenefits = locale === 'ar'
        ? ['تسوق من مئات البائعين', 'طرق دفع متعددة وآمنة', 'توصيل سريع وموثوق']
        : ['Shop from hundreds of sellers', 'Multiple secure payment methods', 'Fast and reliable delivery'];
        ...
        <>
                ...
                <Container>
                    <div className="mx-auto max-w-3xl text-center">
                        <Heading level="h1" className="text-white">
                            {locale === 'ar' ? 'متجر توتيا' : t('platform.title')}
                        </Heading>
            ...
            <Section>
                <Container className="mx-auto max-w-3xl">
                    <Heading level="h2">
                        {locale === 'ar' ? 'ما هو متجر توتيا؟' : 'What is Matger-TUTIA?'}
                    </Heading>
                ...
                <Container>
                    <div className="grid gap-10 md:grid-cols-2">
                        <div className="rounded-xl border border-neutral-200 bg-white p-8">
                            ...
                            <Heading level="h3">{t('platform.forSellers')}</Heading>
                            <ul className="mt-6 space-y-3">
                                {sellerBenefits.map((benefit, i) => (
                                    <li key={i} className="flex items-start gap-3">
                                        ...
                                        <Text variant="body" className="text-neutral-700">{benefit}</Text>
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="rounded-xl border border-neutral-200 bg-white p-8">
                            ...
                            <Heading level="h3">{t('platform.forBuyers')}</Heading>
                            <ul className="mt-6 space-y-3">
            ...
            <Section background="navy">
                <Container className="mx-auto max-w-3xl text-center">
                    <Heading level="h2" className="text-white">
                        {locale === 'ar' ? 'انضم إلى سوق متجر توتيا' : 'Join the Matger-TUTIA Marketplace'}
                    </Heading>
                    <Text variant="body-lg" className="mt-4 text-neutral-300">
                        {locale === 'ar'
