            ...
            <div className="flex min-h-screen items-center justify-center bg-[#0a0a0f] p-4">
                <div className="w-full max-w-sm rounded-lg border border-[#1e1e2a] bg-[#0f0f14] p-6">
                    <div className="mb-6 text-center">
                        <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-md bg-[#3b6cdb] text-sm font-bold text-white">
                            T
                        </div>
                        <h1 className="text-base font-semibold text-[#e8e8ed]">
                            Customer Portal
                        </h1>
                        <p className="mt-1 text-[11px] text-[#8b8b9e]">
                            Enter your access link to continue
                        </p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="mb-1 block text-[11px] font-medium text-[#8b8b9e]">
                                Access Token
                            </label>
                            <input
                                type="text"
