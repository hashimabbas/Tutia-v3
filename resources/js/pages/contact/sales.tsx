...
export default function Sales() {
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'تحدث إلى فريق المبيعات' : 'Talk to Our Sales Team'}>
                <meta name="description" content={locale === 'ar' ? 'تواصل مع فريق مبيعات توتيا للاستفسار عن خدماتنا' : 'Contact the TUTIA sales team to inquire about our services'} />
            </Head>
                ...
                <Container>
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <Heading level="h1" className="text-white">
                            {locale === 'ar' ? 'تحدث إلى فريق المبيعات' : 'Talk to Our Sales Team'}
                        </Heading>
                        ...
                        <div className="md:col-span-3">
                            <form onSubmit={handleSubmit} className="rounded-xl border border-neutral-200 bg-white p-6 md:p-8">
                                ...
                                <div className="grid gap-6 md:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="service">{locale === 'ar' ? 'الخدمة المطلوبة' : 'Service Interest'} *</Label>
                                        <Select
                                            value={data.service}
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <Text variant="body" className="font-semibold text-neutral-900">
                                            {locale === 'ar' ? 'تفضل بالاتصال' : 'Prefer to call?'}
                                        </Text>
