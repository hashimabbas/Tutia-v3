...
import { CheckCircle, Briefcase, BookOpen, Store, ArrowRight } from 'lucide-react';
import { Section, Container, Heading, Text } from '@/components/design-system';
import { Button } from '@/components/ui/button';
import { useI18n } from '@/lib/i18n';

const resources = [
    { icon: Briefcase, href: '/work', en: 'View Our Work', ar: 'أعمالنا', descEn: 'See our latest projects and case studies', descAr: 'اطلع على أحدث مشاريعنا ودراسات الحالة' },
    { icon: BookOpen, href: '/insights', en: 'Read Our Insights', ar: 'المدونة', descEn: 'Explore articles and industry insights', descAr: 'استعرض المقالات والرؤى التقنية' },
    { icon: Store, href: '/platform', en: 'Explore Matger-TUTIA', ar: 'متجر توتيا', descEn: 'Discover Sudan\'s first multi-vendor marketplace', descAr: 'اكتشف أول سوق إلكتروني متعدد البائعين في السودان' },
];
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'شكراً لتواصلك معنا' : 'Thank You'}>
                <meta name="description" content={locale === 'ar' ? 'شكراً لتواصلك مع توتيا. سنرد عليك خلال 24 ساعة' : 'Thank you for contacting TUTIA. We will get back to you within 24 hours'} />
            </Head>
            ...
            <Section background="muted">
                <Container>
                    <div className="mx-auto max-w-3xl text-center">
                        <Heading level="h2">
                            {locale === 'ar' ? 'بينما تنتظر...' : 'While you wait...'}
                        </Heading>
                        ...
                        {resources.map((r) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Heading level="h4" className="group-hover:text-brand-navy-500">
                                        {locale === 'ar' ? r.ar : r.en}
                                    </Heading>
