    ...
    const services = [
        {
            ...
            titleAr: 'بوابة الدفع',
            description:
                'Secure payment processing solutions with multi-currency support and recurring billing.',
            descriptionAr:
                'حلول معالجة مدفوعات آمنة مع دعم متعدد العملات والفواتير المتكررة.',
        ...
        },
        {
            ...
            description:
                'Comprehensive ERP solutions for financial management, accounting, and operations.',
            descriptionAr:
                'حلول تخطيط موارد مؤسسية شاملة للإدارة المالية والمحاسبة والعمليات.',
            href: '/services/erp',
        },
        {
            icon: BrainCircuit,
            ...
            description:
                'Technology strategy and advisory for digital transformation in financial services.',
            descriptionAr:
                'استراتيجية تقنية واستشارات للتحول الرقمي في الخدمات المالية.',
        ...
        <>
            ...
            >
                <meta
                    ...
                    content={
                        locale === 'ar'
                            ? 'حلول البنوك والمالية من توتيا'
                            : 'TUTIA banking and finance solutions'
                    }
                />
            </Head>
