...
import { Store, ShoppingCart, CreditCard, Globe, ArrowLeft, ArrowRight } from 'lucide-react';
...
export default function RetailEcommerce() {
    ...
    const services = [
        {
            ...
            description: 'Multi-vendor marketplace platform and custom online stores tailored to the Sudanese market.',
            descriptionAr: 'منصة سوق متعدد البائعين ومتاجر إلكترونية مخصصة للسوق السوداني.',
        ...
        },
        {
            ...
            description: 'Secure multi-currency payment processing with local and international payment methods.',
            descriptionAr: 'معالجة مدفوعات آمنة متعددة العملات بطرق دفع محلية ودولية.',
        ...
        },
        {
            ...
            description: 'Professional websites and web applications for retail businesses of all sizes.',
            descriptionAr: 'مواقع إلكترونية وتطبيقات ويب احترافية لشركات التجزئة بمختلف الأحجام.',
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'التجزئة والتجارة الإلكترونية' : 'Retail & E-Commerce'}>
                <meta name="description" content={locale === 'ar' ? 'حلول التجزئة والتجارة الإلكترونية من توتيا' : 'TUTIA retail and e-commerce solutions for Sudanese businesses'} />
            </Head>
                ...
                <Container>
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <Heading level="h1" className="text-white">
                            {locale === 'ar' ? 'التجزئة والتجارة الإلكترونية' : 'Retail & E-Commerce'}
                        </Heading>
                    ...
                    <div className="mt-6">
                        <Button asChild variant="link" className="text-brand-navy-500">
                            <Link href="/work/matger-tutia">
                                {locale === 'ar' ? 'عرض دراسة حالة متجر توتيا' : 'View Matger-TUTIA Case Study'}
            ...
            <Section background="navy">
                <Container className="mx-auto max-w-3xl text-center">
                    <Heading level="h2" className="text-white">
                        {locale === 'ar' ? 'استعد للتحول الرقمي' : 'Ready to Go Digital?'}
                    </Heading>
                    <Text variant="body-lg" className="mt-4 text-neutral-300">
                        {locale === 'ar'
