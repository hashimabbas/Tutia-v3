...
import { Radio, Wifi, Shield, BrainCircuit, ArrowLeft, ArrowRight } from 'lucide-react';
    ...
    const services = [
        {
            ...
            description: 'Mobile and Wi-Fi coverage deployment, network assessment, and maintenance services.',
            descriptionAr: 'نشر التغطية الجوالة واللاسلكية وتقييم الشبكات وخدمات الصيانة.',
        ...
        },
        {
            ...
            description: 'Secure business VPN solutions for remote connectivity and data protection.',
            descriptionAr: 'حلول شبكات خاصة آمنة للشركات للاتصال عن بعد وحماية البيانات.',
            href: '/services/vpn',
        },
        {
            icon: BrainCircuit,
            ...
            description: 'Technology strategy, infrastructure planning, and digital advisory for telecom operators.',
            descriptionAr: 'استراتيجية تقنية وتخطيط البنية التحتية واستشارات رقمية لمشغلي الاتصالات.',
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'الاتصالات' : 'Telecommunications'}>
                <meta name="description" content={locale === 'ar' ? 'حلول الاتصالات من توتيا' : 'TUTIA telecommunications solutions'} />
            </Head>
                ...
                <Container>
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <Heading level="h1" className="text-white">
                            {locale === 'ar' ? 'الاتصالات' : 'Telecommunications'}
                        </Heading>
                    ...
                    <div className="mt-6">
                        <Button asChild variant="link" className="text-brand-navy-500">
                            <Link href="/work/connectivity-project">
                                {locale === 'ar' ? 'عرض دراسة حالة الاتصال' : 'View Connectivity Case Study'}
            ...
            <Section background="navy">
                <Container className="mx-auto max-w-3xl text-center">
                    <Heading level="h2" className="text-white">
                        {locale === 'ar' ? 'طور بنيتك التحتية' : 'Enhance Your Infrastructure'}
                    </Heading>
                    <Text variant="body-lg" className="mt-4 text-neutral-300">
                        {locale === 'ar'
