            ...
            ? [
                  {
                      ...
                      desc: 'منصة B2C تجمع البائعين والمشترين في سوق إلكتروني متكامل',
                  },
                  {
                      icon: Smartphone,
                      title: 'تطبيق جوال',
                      desc: 'متوفر على أندرويد و iOS لتجربة تسوق سهلة من أي مكان',
                  },
                  {
                      icon: Globe,
                      title: 'متجر إلكتروني',
                      desc: 'منصة رقمية متكاملة على www.Matger-tutia.sd',
                  },
                  {
                      icon: Palette,
                      title: 'علامات تجارية',
                      desc: 'نساعد في بناء العلامات التجارية بمنتجات عالية الجودة',
                  },
              ]
            : [
                  {
                      ...
                      desc: 'B2C platform connecting sellers and buyers in a comprehensive digital marketplace',
                  },
                  {
                      icon: Smartphone,
                      title: 'Mobile Application',
                      desc: 'Available on Android and iOS for seamless shopping anywhere',
                  },
                  {
                      icon: Globe,
                      title: 'Online Store',
                      desc: 'Full-featured digital platform at www.Matger-tutia.sd',
                  },
                  {
                      icon: Palette,
                      title: 'Brand Building',
                      desc: 'We help build brands with high-quality products and fast delivery',
                  },
              ];
    ...
    return (
        <>
            ...
            >
                <meta
                    name="description"
                    content="Matger-TUTIA multi-vendor B2C e-commerce marketplace with mobile apps and web platform"
                />
            </Head>
            ...
            >
                <div className="absolute inset-0">
                    <img
                        src="/images/services/online-shop-g7a91d4a91_640.png"
                        alt=""
                    ...
                    <div className="mx-auto grid max-w-5xl items-center gap-12 md:grid-cols-2">
                        <div>
                            ...
                            <div className="mt-6 space-y-1">
                                <a
                                    href="https://matger-tutia.com/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-brand-gold-500 underline underline-offset-4 hover:text-brand-gold-600"
                                >
                                    www.Matger-tutia.sd
                                </a>
                            </div>
                ...
                <Container>
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-3">
                        {categories.map((cat, i) => (
                            <span
                                key={i}
                                className="hover:text-brand-gold-700 rounded-full border border-neutral-200 bg-white px-5 py-2 text-sm font-medium text-neutral-700 shadow-sm transition-all hover:border-brand-gold-300"
                            >
                                {cat}
                            </span>
                        ))}
