            ...
            ? [
                  {
                      ...
                      desc: 'قبول جميع بطاقات الائتمان الرئيسية بسلاسة وأمان',
                  },
                  {
                      icon: Wallet,
                      title: 'المحافظ الرقمية',
                      desc: 'دعم المحافظ الرقمية ومنصات التجارة الإلكترونية',
                  },
                  {
                      icon: Globe,
                      title: 'عملات متعددة',
                      desc: 'معالجة المدفوعات بعملات أجنبية مختلفة',
                  },
                  {
                      icon: RefreshCw,
                      title: 'فواتير متكررة',
                      desc: 'إعداد الفواتير المتكررة وإدارة الاشتراكات',
                  },
                  {
                      icon: BarChart3,
                      title: 'لوحة تحكم',
                      desc: 'تتبع جميع معاملاتك عبر لوحة إدارة الحساب',
                  },
              ]
            : [
                  {
                      icon: CreditCard,
                      title: 'Credit Cards',
                      desc: 'Accept all major credit card networks seamlessly',
                  },
                  {
                      icon: Wallet,
                      title: 'Digital Wallets',
                      desc: 'Support for digital wallets and e-commerce platforms',
                  },
                  {
                      icon: Globe,
                      title: 'Multi-Currency',
                      desc: 'Process payments in different foreign currencies',
                  },
                  {
                      icon: RefreshCw,
                      title: 'Recurring Billing',
                      desc: 'Set up recurring billing and subscription management',
                  },
                  {
                      icon: BarChart3,
                      title: 'Dashboard',
                      desc: 'Track all transactions via account management dashboard',
                  },
              ];
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'بوابة الدفع' : 'Payment Gateway'}>
                <meta
                    name="description"
                    content="Payment gateway solution working with all major credit card networks, digital wallets, and multi-currency support"
                />
            </Head>
            ...
            >
                <div className="absolute inset-0">
                    <img
                        src="/images/services/payment.jpg"
                        alt=""
