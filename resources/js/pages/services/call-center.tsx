    ...
    const solutions =
        locale === 'ar'
            ? [
                  {
                      icon: Workflow,
                      title: 'الجيل التالي لمراكز الاتصال',
                      desc: 'حلول متطورة لمراكز الاتصال تدعم القنوات الرقمية إلى جانب المكالمات',
                  },
                  {
                      icon: MessageCircle,
                      title: 'إدارة تجربة العملاء',
                      desc: 'تجربة موحدة ومتكاملة عبر جميع نقاط الاتصال والقنوات',
                  },
                  {
                      icon: Phone,
                      title: 'الاتصال متعدد القنوات',
                      desc: 'تجربة سلسة متعددة القنوات تحافظ على السياق عبر التفاعلات',
                  },
                  {
                      icon: BarChart3,
                      title: 'خفض تكلفة الخدمة',
                      desc: 'تحسين العمليات التجارية لتقليل تكلفة الخدمة مع تحسين الجودة',
                  },
              ]
            : [
                  {
                      icon: Workflow,
                      title: 'Next-Gen Contact Center',
                      desc: 'Advanced contact center solutions supporting digital channels beyond phone calls',
                  },
                  {
                      icon: MessageCircle,
                      title: 'Customer Experience Management',
                      desc: 'Unified omnichannel experience at every touchpoint and channel',
                  },
                  {
                      icon: Phone,
                      title: 'Omnichannel Communication',
                      desc: 'Seamless multi-channel experience preserving context across interactions',
                  },
                  {
                      icon: BarChart3,
                      title: 'Lower Cost to Serve',
                      desc: 'Business process optimization to reduce service costs while improving quality',
                  },
              ];
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'مركز الاتصال' : 'Call Center'}>
                <meta
                    name="description"
                    content="TUTIA Customer Experience Platform — omnichannel call center solutions for unified customer service"
                />
            </Head>
            ...
            >
                <div className="absolute inset-0">
                    <img
                        src="/images/services/call-centre.jpg"
                        alt=""
            ...
            <Section>
                <Container className="mx-auto max-w-3xl">
                    <Heading level="h2">
                        {locale === 'ar'
                            ? 'فوائد إدارة مراكز اتصال توتيا'
                            : 'TUTIA Call Center Benefits'}
                    </Heading>
