    ...
    const benefits =
        locale === 'ar'
            ? [
                  {
                      icon: Lock,
                      title: 'الوصول إلى موارد الشركة عن بُعد',
                      desc: 'الوصول الآمن إلى قواعد بيانات الشركة والأدوات الإلكترونية وحسابات العمل من أي مكان',
                  },
                  {
                      icon: Wifi,
                      title: 'العمل بأمان على أي شبكة Wi-Fi',
                      desc: 'حماية بياناتك من التهديدات الإلكترونية عند الاتصال من المطار أو الفندق أو الأماكن العامة',
                  },
                  {
                      icon: Server,
                      title: 'خوادم شركة مخصصة',
                      desc: 'خوادم VPN مخصصة للشركة بأداء عالٍ وسرعة فائقة وعناوين IP ثابتة',
                  },
                  {
                      icon: Globe,
                      title: 'IP ثابت وآمن',
                      desc: 'نفس عنوان IP في كل اتصال لضمان وصول آمن للموارد الداخلية والخدمات الحساسة',
                  },
              ]
            : [
                  {
                      ...
                      desc: 'Secure access to company databases, online tools, and work accounts from anywhere',
                  },
                  {
                      icon: Wifi,
                      title: 'Work Safely on Any Wi-Fi',
                      desc: 'Protect your data from cyber threats when connecting from airports, hotels, or public spaces',
                  },
                  {
                      icon: Server,
                      title: 'Dedicated Company Servers',
                      desc: 'High-performance business VPN servers dedicated exclusively to your company with static IPs',
                  },
                  {
                      icon: Globe,
                      title: 'Static Secure IP',
                      desc: 'Same IP address every time you connect, ensuring secure access to internal resources',
                  },
              ];
    ...
    return (
        <>
            <Head title={locale === 'ar' ? 'VPN توتيا' : 'TUTIA VPN'}>
                <meta
                    name="description"
                    content="Business VPN solutions — secure remote access, data protection, dedicated servers, and static IPs"
                />
            </Head>
            ...
            >
                <div className="absolute inset-0">
                    <img
                        src="/images/services/vpn_safety.jpg"
                        alt=""
                    ...
                    <div className="mt-10 grid gap-6 md:grid-cols-2">
                        {benefits.map((benefit, i) => {
                            ...
                            return (
                                <div
                                    key={i}
                                    className="rounded-xl border border-neutral-200 bg-white p-6 transition-all hover:border-brand-navy-200 hover:shadow-md"
                                >
