            ...
            ? [
                  {
                      icon: ShoppingCart,
                      title: 'المبيعات',
                      desc: 'إدارة المبيعات وحجوزات السفر وعمليات البيع',
                  },
                  {
                      icon: Users,
                      title: 'التسويق',
                      desc: 'إدارة الحملات التسويقية واستهداف العملاء المحتملين',
                  },
                  {
                      icon: Settings,
                      title: 'العمليات',
                      desc: 'أتمتة العمليات التشغيلية اليومية لوكالات السفر',
                  },
                  {
                      icon: BarChart3,
                      title: 'المالية',
                      desc: 'إدارة الفواتير والمدفوعات والتقارير المالية',
                  },
              ]
            : [
                  {
                      icon: ShoppingCart,
                      title: 'Sales',
                      desc: 'Sales management, travel bookings, and point-of-sale operations',
                  },
                  {
                      icon: Users,
                      title: 'Marketing',
                      desc: 'Marketing campaign management and customer targeting',
                  },
                  {
                      icon: Settings,
                      title: 'Operations',
                      desc: 'Automation of daily travel agency operations',
                  },
                  {
                      icon: BarChart3,
                      title: 'Finance',
                      desc: 'Invoice management, payments, and financial reporting',
                  },
              ];
    ...
    return (
        <>
            ...
            >
                <meta
                    name="description"
                    content="TUTIA ticketing system automates sales, marketing, operations, and finance for travel agencies"
                />
            </Head>
            ...
            >
                <div className="absolute inset-0">
                    <img
                        src="/images/services/tickting.png"
                        alt=""
            ...
            <Section>
                <Container className="mx-auto max-w-3xl text-center">
                    <Heading level="h2">
                        {locale === 'ar'
                            ? 'لماذا تختار نظام توتيا؟'
                            : 'Why Choose TUTIA Ticketing?'}
                    </Heading>
