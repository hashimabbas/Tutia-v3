    ...
    const domains =
        locale === 'ar'
            ? [
                  {
                      icon: Globe,
                      title: 'الخدمات الإلكترونية الفعالة',
                      desc: 'تصميم وتنفيذ خدمات إلكترونية مبتكرة تلبي احتياجات المستخدمين',
                  },
                  {
                      icon: Building2,
                      title: 'أنظمة النقل المتطورة',
                      desc: 'استشارات في أنظمة النقل الذكية والبنية التحتية للمواصلات',
                  },
                  {
                      icon: Network,
                      title: 'شبكات الاتصالات',
                      desc: 'تصميم وإدارة شبكات الاتصالات وتكنولوجيا المعلومات في المباني',
                  },
                  {
                      icon: Shield,
                      title: 'البنية التحتية التقنية',
                      desc: 'تقييم وتطوير البنية التحتية لتكنولوجيا المعلومات',
                  },
              ]
            : [
                  {
                      icon: Globe,
                      title: 'Efficient Online Services',
                      desc: 'Design and implement innovative digital services that meet user requirements',
                  },
                  {
                      icon: Building2,
                      title: 'Transportation Systems',
                      desc: 'Consultancy on intelligent transport systems and transportation infrastructure',
                  },
                  {
                      icon: Network,
                      title: 'Communications Networks',
                      desc: 'Design and management of IT and communications networks in buildings',
                  },
                  {
                      icon: Shield,
                      title: 'Technical Infrastructure',
                      desc: 'Assessment and development of technology infrastructure',
                  },
              ];
    ...
    return (
        <>
            ...
            >
                <meta
                    name="description"
                    content="ICT consultancy covering the full lifecycle of technology systems — from strategy to implementation to ongoing management"
                />
            </Head>
            ...
            >
                <div className="absolute inset-0">
                    <img
                        src="/images/services/business-gbf.jpg"
                        alt=""
