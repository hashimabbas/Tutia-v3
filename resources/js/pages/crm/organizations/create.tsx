...
export default function OrganizationCreate({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const data = {
            ...form,
            classifications:
                form.classification_ids.length > 0
    ...
    return (
        <>
            <Head
                title={
                    isEditing
                        ? `CRM · Edit ${organization.name}`
                        : 'CRM · New Organization'
                }
            />
                    ...
                    <div className="flex items-center justify-between px-6 py-4">
                        <div className="flex items-center gap-4">
                            <Link
                                href={
                                    isEditing
                                        ? `/crm/organizations/${organization.id}`
                                        : '/crm/organizations'
                                }
                                ...
                                <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                                    ...
                                    <div data-field="domain">
                                        ...
                                        <div className="relative">
                                            <Globe className="pointer-events-none absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2 text-[#9ca3af]" />
                                            <Input
                                                id="domain"
                                                value={form.domain}
                                                onChange={(e) =>
                                ...
                                <section className="rounded-2xl border border-[#e2e6ef] bg-white p-6 shadow-sm">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {classifications.map((c) => {
                                            const selected =
                                                form.classification_ids.includes(
                                                    String(c.id),
                                                );
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        selected
                                                            ? 'border-[#2B4C8C] bg-[#2B4C8C]/5 font-medium text-[#2B4C8C] ring-1 ring-[#2B4C8C]/20'
