...
export default function OrganizationIndex({
    ...
    const applyFilter = (key: string, val: string) => {
        navigate({
            ...
            classification:
                key === 'classification' ? val : classificationFilter,
            industry: key === 'industry' ? val : industryFilter,
        });
    };

    const hasActiveFilters =
        filters.search || filters.classification || filters.industry;
                ...
                <div className="sticky top-0 z-20 border-b border-[#e2e6ef] bg-[#f8f9fc]/80 backdrop-blur-xl">
                    <div className="flex items-center justify-between px-6 py-4">
                        <div>
                            ...
                            <p className="text-[11px] text-[#6b7280]">
                                Manage companies and institutional relationships
                            </p>
                        </div>
                    ...
                    <div className="flex items-center gap-2 border-t border-[#e2e6ef] px-6 py-2.5">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent
                                align="start"
                                className="max-h-60 w-48 overflow-y-auto border-[#e2e6ef] bg-white text-xs text-[#1a1a2e]"
                            >
                                <DropdownMenuLabel className="text-[10px] font-medium tracking-wider text-[#6b7280] uppercase">
                                    Filter by industry
                                </DropdownMenuLabel>
