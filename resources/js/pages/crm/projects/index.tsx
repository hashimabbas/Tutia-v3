                ...
                <div className="flex items-center gap-3 border-b border-[#e2e6ef] px-6 py-2.5">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full rounded-md border border-[#e2e6ef] bg-white py-1.5 pr-3 pl-8 text-xs text-[#1a1a2e] placeholder-[#6b7280] outline-none focus:border-[#2B4C8C]"
                        />
                    </div>
                    <select
                        ...
                        <div className="flex h-64 items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="mt-1 text-xs text-[#6b7280]">
                                    Convert a deal to create your first project.
                                </p>
                            </div>
                        </div>
                    )}
