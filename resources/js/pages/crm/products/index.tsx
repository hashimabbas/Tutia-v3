...
export default function ProductIndex({ products, categories }: Props) {
    ...
    const filtered = Object.entries(products).reduce<Record<string, Product[]>>(
        (acc, [cat, items]) => {
                ...
                <div className="flex gap-3 overflow-x-auto border-b border-[#e2e6ef] bg-white px-6 py-3">
                    {categories.map((cat) => {
                        ...
                        return (
                            <div
                                key={cat.category}
                                className="flex shrink-0 items-center gap-2.5 rounded-xl border border-[#e2e6ef] bg-[#f8f9fc] px-3.5 py-2 shadow-sm"
                            >
                ...
                <div className="flex items-center gap-3 border-b border-[#e2e6ef] bg-white px-6 py-3">
                    <div className="relative max-w-sm flex-1">
                        ...
                        <input
                            ...
                            className="h-9 w-full rounded-xl border border-[#e2e6ef] bg-[#f8f9fc] pr-3 pl-9 text-xs text-[#1a1a2e] placeholder-[#9ca3af] transition-all outline-none focus:border-[#2B4C8C] focus:ring-[3px] focus:ring-[#2B4C8C]/10"
                        />
                    </div>
                    <div className="w-36">
                        <Select
                        ...
                        >
                            <SelectTrigger className="h-9 border-[#e2e6ef] text-xs">
                                <Filter className="mr-1.5 h-3 w-3 text-[#9ca3af]" />
                    ...
                    <div className="flex items-center rounded-xl border border-[#e2e6ef] bg-[#f8f9fc] p-0.5">
                        <button
                            ...
                            className={cn(
                                ...
                                view === 'grid'
                                    ? 'bg-white text-[#2B4C8C] shadow-sm'
                                            ...
                                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                                {items.map((p) => (
                                                    ...
                                                    >
                                                        <div className="mb-2 flex items-start justify-between">
                                                            <div className="flex min-w-0 items-center gap-2">
                                                                ...
                                                                <div className="min-w-0">
                                                                    <Link
                                                                        ...
                                                                        className="block truncate text-sm font-medium text-[#1a1a2e] hover:text-[#2B4C8C]"
                                                                    >
                                                                        {p.name}
                                                                    </Link>
                                                                </div>
                                                            ...
                                                            <DropdownMenu>
                                                                <DropdownMenuTrigger
                                                                    asChild
                                                                >
                                                                    <button className="flex h-6 w-6 items-center justify-center rounded-lg text-[#9ca3af] opacity-0 transition-all group-hover:opacity-100 hover:bg-[#f0f2f7] hover:text-[#6b7280]">
                                                        ...
                                                        {p.description && (
                                                            <p className="mb-2.5 line-clamp-2 text-[11px] leading-relaxed text-[#6b7280]">
                                                                {p.description}
                                                            </p>
                                                        )}

                                                        <div className="flex items-center justify-between border-t border-[#f0f2f7] pt-2">
                                                            <div className="flex items-center gap-1.5">
                                                                <span
                                                                    className={cn(
                                                                        'rounded-md border px-1.5 py-0.5 text-[9px] font-medium tracking-wider uppercase',
                                                                        typeColors[
                                                                            p
                                                                                .type
                                                                        ] ??
                                                ...
                                                <table className="w-full text-sm">
                                                    <thead>
                                                        <tr className="border-b border-[#f0f2f7] bg-[#f8f9fc]">
                                                            <th className="px-4 py-2.5 text-left text-[11px] font-medium tracking-wider text-[#6b7280] uppercase">
                                                                Product
                                                            </th>
                                                            <th className="px-4 py-2.5 text-left text-[11px] font-medium tracking-wider text-[#6b7280] uppercase">
                                                                Type
                                                            </th>
                                                            <th className="px-4 py-2.5 text-right text-[11px] font-medium tracking-wider text-[#6b7280] uppercase">
                                                                Version
                                                            </th>
                                                            <th className="px-4 py-2.5 text-right text-[11px] font-medium tracking-wider text-[#6b7280] uppercase">
                                                                Price
                                                    ...
                                                    <tbody>
                                                        {items.map((p) => (
                                                            <tr
                                                                key={p.id}
                                                                className="group border-b border-[#f0f2f7] last:border-0 hover:bg-[#f8f9fc]"
                                                            >
                                                                <td className="px-4 py-3">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            {p.description && (
                                                                                <p className="max-w-xs truncate text-[11px] text-[#6b7280]">
                                                                                    {
                                                                                        p.description
                                                                                    }
                                                                                </p>
                                                                ...
                                                                <td className="px-4 py-3">
                                                                    <DropdownMenu>
                                                                        <DropdownMenuTrigger
                                                                            asChild
                                                                        >
                                                                            <button className="flex h-7 w-7 items-center justify-center rounded-lg text-[#9ca3af] opacity-0 transition-all group-hover:opacity-100 hover:bg-[#f0f2f7] hover:text-[#6b7280]">
                                                                                <MoreHorizontal className="h-3.5 w-3.5" />
                                                                            </button>
                                                                        </DropdownMenuTrigger>
                                                                        <DropdownMenuContent
