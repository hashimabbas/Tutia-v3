                ...
                <div className="sticky top-0 z-10 border-b border-[#e2e6ef] bg-white/90 px-6 py-3 backdrop-blur-xl">
                    <div className="flex items-center justify-between">
                        ...
                        >
                            ...
                            Filters
                            {hasActiveFilters && (
                                <span className="ml-0.5 rounded-full bg-[#2B4C8C] px-1.5 py-0.5 text-[9px] text-white">
                                    {
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-[#e2e6ef] bg-[#f8f9fc]">
                                        <th className="px-4 py-3 text-left text-[10px] font-semibold tracking-wider text-[#6b7280] uppercase">
                                            ID
                                        </th>
                                        <th className="px-4 py-3 text-left text-[10px] font-semibold tracking-wider text-[#6b7280] uppercase">
                                            Flow
                                        ...
                                        <th className="px-4 py-3 text-right text-[10px] font-semibold tracking-wider text-[#6b7280] uppercase">
                                            Actions
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    {requests.data.map((req) => (
                                        <tr
                                            ...
                                            onClick={() =>
                                                router.visit(
                                                    `/crm/approvals/${req.id}`,
                                                )
                                            }
                                        >
                                            <td className="px-4 py-3.5 text-xs font-medium text-[#6b7280]">
                                                #{req.id}
                                            </td>
                                            ...
                                            <td className="px-4 py-3.5">
                                                <span
                                                    className={cn(
                                                        'inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-[10px] capitalize',
                                                        statusColors[
                                                            req.status
                                                        ] ??
